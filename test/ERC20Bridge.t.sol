...
contract ERC20BridgeTest is Test {
    ...
    function testUnlockSuccess() public {
        ...
        (uint8 v1, bytes32 r1, bytes32 s1) = vm.sign(relayer1Pk, ethSignedHash);

        (uint8 v2, bytes32 r2, bytes32 s2) = vm.sign(relayer2Pk, ethSignedHash);
